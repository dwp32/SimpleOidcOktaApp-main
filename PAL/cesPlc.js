...
////// Okta has a problem wh

async function cesPlc(req, resp)
{
   ////// THIS IS A WORKING LINK FOR THE Provisioning Login Checker!!! //////
   ...
   let location = "https://" + process.env.CES_CUSTOM_URL +
      ...
      "&redirect_uri=" + "http://localhost:3000/cesPal" + //process.env.PIC_WEB_ADDR +
